...
function TopImagesScaffold() {
    return (
        <div className="container">
            <div className="row">
                <div className="col-md-4 px-3 border border-success py-3 mt-5 sticky-sun">
                    ...
                    <section className="bg-white">
                        <div className="border border-success mt-sm-2 mt-md-5">
                            ...
                            >
                                ...
                                funny time.
                                But chill out with these funny memes
...
export default TopImagesScaffold
